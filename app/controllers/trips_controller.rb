class TripsController < ApplicationController
  ...
  # TODO trips should also be retournable in json format for external APIs
  # TODO trips should also be retournable in gmaps readable format for import
  # TODO trips should also be retournable in navi readable format for import
