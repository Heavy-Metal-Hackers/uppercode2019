...
Rails.application.config.assets.precompile += %w( html2canvas.min.js )
Rails.application.config.assets.precompile += %w( platform.js )
Rails.application.config.assets.precompile += %w( dragend.min.js )
Rails.application.config.assets.precompile += %w( JsBarcode.all.min.js )
